...
## <a name="offsetSet">`ArrayAccessTrait::offsetSet()`</a>

```php
ArrayAccessTrait::offsetSet(mixed $offset, mixed $value)
```
...
## <a name="offsetUnset">`ArrayAccessTrait::offsetUnset()`</a>

```php
ArrayAccessTrait::offsetUnset(mixed $offset)
```
